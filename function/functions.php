<?php 
	...
	// Sesuaikan data di bawah dengan yang ada di Client Area / Control Panel InfinityFree Anda
$hostname = "localhost"; // Ganti XXX dengan nomor server Anda
$username = "root";           // Username database (biasanya diawali if0_)
$password = "";            // Password hosting (bukan password login panel)
$database = "website_sekolah";    // Nama database yang Anda buat di panel
