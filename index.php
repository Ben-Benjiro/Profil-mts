    ...
    <nav class="green darken-2">
        <div class="container">
            <div class="nav-wrapper">
                <a href="#!" class="brand-logo left" style="display: flex; align-items: center; width: 60%;">
                    <img src="assets/img/mts.png" style="width: 45px; margin-top: 6px;">
                    <span class="logo-text" style="margin-left: 10px; line-height: 1.2; font-size: 1.1rem;">
    ...
    <!-- footer -->
        ...
        <footer class="page-footer green darken-1">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Anda Telah Berkunjung Ke Situs Resmi Dari MTs Muh 2 Karanganyar</p>
                <p>
                	LOKASI: Ponpes Al-Ma'un, Jl. Sroyo-Jaten No.10, Sroyo, Kec. Jaten, Kabupaten Karanganyar, Jawa Tengah 57771
                </p>
              </div>
          ...
          <div class="footer-copyright green darken-3">
            <div class="container">
            <h5 class="center"> Teknik Komputer UMUKA @copyright <?php echo date("Y");  ?></h5>
            </div>
          </div>
        </footer>
